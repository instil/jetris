...
public class GameView implements GameModelListener {
    ...
    private static class GamePanel extends JPanel {
        ...
        private void paintInitialScreen(Graphics graphics) {
            graphics.setFont(new Font("Arial", Font.BOLD, 30));
            graphics.setColor(Color.WHITE);
            graphics.drawString("Start Game Y/N?", 150, 150);
        }

        private void paintPausedScreen(Graphics graphics) {
        ...
        private void drawNextBlock(Block block, Graphics graphics) {
        ...
        private void drawBoardBlock(Block block, Graphics graphics) {
            graphics.setColor(colorOf(block));
        ...
        private Color colorOf(Block block) {
            switch (block.color()) {
                case BLUE:
                    return Color.BLUE;
                case CYAN:
        ...
        private void drawNumeric(int value, Graphics graphics, int x, int y) {
